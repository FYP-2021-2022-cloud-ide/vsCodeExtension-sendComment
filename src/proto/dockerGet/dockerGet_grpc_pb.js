...
function serialize_dockerGet_ChangeNotificationReadRequest(arg) {
  if (!(arg instanceof dockerGet_pb.ChangeNotificationReadRequest)) {
    throw new Error('Expected argument of type dockerGet.ChangeNotificationReadRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_dockerGet_ChangeNotificationReadRequest(buffer_arg) {
  return dockerGet_pb.ChangeNotificationReadRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var DockerService = exports.DockerService = {
  ...
  changeNotificationRead: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: dockerGet_pb.ChangeNotificationReadRequest,
    responseType: dockerGet_pb.SuccessStringReply,
    requestSerialize: serialize_dockerGet_ChangeNotificationReadRequest,
    requestDeserialize: deserialize_dockerGet_ChangeNotificationReadRequest,
    responseSerialize: serialize_dockerGet_SuccessStringReply,
    responseDeserialize: deserialize_dockerGet_SuccessStringReply,
  },
  removeNotification: {
